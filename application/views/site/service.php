        ...
        <div class="container">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <hr/>
                    <form action="<?php echo site_url('site/service'); ?>" method="post">
                        <div class="form-row">
                            <div class="form-group col-md-5">
                                <label for="kriteria1">Tanggal Estimasi</label>
                                <input type="text" class="form-control" name="tanggal" id="tanggal" placeholder="Masukkan Tanggal Estimasi" required="true">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-5">
                            ...
                            <div class="form-group col-md-5">
                                ...
                                <select class="form-control" name="jenis_service" id="jenis_service" required="required">
                                    <option selected value=""> Pilih Jenis Service</option>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <textarea rows="4" cols="50" placeholder="Masukan Catatan" class="form-control" name="catatan" id="perbaikan"></textarea>
                            </div>
                        </div>
